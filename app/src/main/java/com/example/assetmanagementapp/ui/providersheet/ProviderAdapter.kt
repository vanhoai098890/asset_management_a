...
class ProviderAdapter : BaseListAdapter<ProviderItem>() {
    var currentSelectedPos = 0
    var onClick: (ProviderItem) -> Unit = {}
    ...
    inner class ViewHolder(private val binding: LayoutItemCategoryBinding) :
        ...
        override fun bind(data: ProviderItem) {
            if (data.isSelected) {
            ...
            binding.data = TypeAsset(typeName = data.name, id = 0)
